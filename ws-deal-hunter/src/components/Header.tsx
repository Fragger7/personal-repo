      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-lg font-bold tracking-tight text-white flex items-center gap-2">
                ...
                <span className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 text-[10px] font-semibold px-2 py-0.5 rounded-full uppercase tracking-wider">
                  Autonomous v1.0
                </span>
              </h1>
            </div>
            <p className="text-xs text-slate-400 flex items-center gap-2 mt-0.5">
              <span>Syndicating eBay API • Reddit r/hws • Swappa RSS</span>
              <span className="inline-block w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
              <span className="text-slate-400">Gemini 2.5 Flash Valuations</span>
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center flex-wrap gap-2.5">
          ...
          >
            ...
            <span>{isSyncing ? "Syndicating Feeds..." : "Sync Endpoints"}</span>
          </button>

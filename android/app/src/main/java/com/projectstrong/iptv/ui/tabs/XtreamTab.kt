                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            Row(modifier = Modifier.fillMaxWidth()) {
                                Column(modifier = Modifier.weight(1f)) {
                                    ...
                                    Text(text = node.user, color = Color.White, style = androidx.compose.material3.MaterialTheme.typography.bodyLarge)
                                }
                                Column(modifier = Modifier.weight(1f)) {
                                    ...
                                    Text(text = node.pass, color = Color.White, style = androidx.compose.material3.MaterialTheme.typography.bodyLarge)
                                }
                            }

    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#03060f] text-slate-900 dark:text-slate-100 selection:bg-blue-700/35 selection:text-white glow-radial select-none pb-12 font-sans overflow-x-hidden relative">
      ...
      <main className="max-w-7xl mx-auto px-4 lg:px-8 mt-8 mb-24 relative z-10 block w-full">
        ...
        >
          ...
          <div className="p-4 bg-white/70 dark:bg-[#080d19]/70 rounded-3xl border border-slate-200 dark:border-white/10 flex flex-col justify-center relative overflow-hidden group hover:border-orange-500/30 transition-all shadow-xl shadow-slate-200/50 dark:shadow-black/40 backdrop-blur-3xl lg:col-span-1">
            <div className="absolute top-0 right-0 p-2 opacity-10 group-hover:opacity-20 transition-opacity">
              <Sparkles size={24} />
            </div>
            <span className="text-[8px] font-bold text-slate-500 uppercase tracking-widest font-mono">

...
object ProviderIntelligenceManager {
    ...
    private val KNOWN_PROVIDERS = listOf(
        ...
        Pair("Crystal OTT", listOf("crystal ott", "crystal iptv", "crystal-ott", "crystalott", "crystal 4k", "crystaltv", "crystal-tv")),
        ...
        Pair("Nexus OTT", listOf("nexus ott", "nexus-ott", "nexusiptv", "nexus 4k", "nexusott")),
        Pair("Vision IPTV", listOf("vision iptv", "vision-iptv", "visionott", "vision 4k", "vision tv")),
        Pair("Matrix IPTV", listOf("matrix iptv", "matrix-iptv", "matrixott", "matrix 4k", "matrix tv")),
        Pair("GoBox IPTV", listOf("gobox", "gobox vip", "gobox-iptv", "gobox 4k", "goboxiptv")),
        Pair("Volka TV", listOf("volka", "volkatv", "volka-tv", "volka pro", "volka 2", "volka pro 2")),
        Pair("Forever IPTV", listOf("forever iptv", "forever-tv", "forevertv", "forever vip", "forever pro")),
        Pair("Platinum OTT", listOf("platinum ott", "ott-platinum", "platinumiptv", "platinum 4k", "platinumott")),
        Pair("Sonic IPTV", listOf("sonic iptv", "sonic-tv", "sonicott", "sonic 4k", "soniciptv")),
        Pair("Eagle IPTV", listOf("eagle iptv", "eagle-iptv", "eagleott", "eagle 4k", "eagleiptv")),
        Pair("Atlas Pro ONTV", listOf("atlas pro", "atlas-pro", "atlaspro", "atlasontv", "atlas pro ontv")),
        ...
        Pair("Lion OTT", listOf("lion-ott", "lion ott", "tvlion", "lion 4k", "lion iptv")),
        Pair("Star IPTV", listOf("star iptv", "star-iptv", "star 4k iptv")),
        Pair("Ultra OTT", listOf("ultra ott", "ultra-ott", "ultraiptv 4k")),
